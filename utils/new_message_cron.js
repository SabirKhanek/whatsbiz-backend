...
module.exports.initCronJob = function initCronJob() {
  console.log(
    "Initializing new message cron job with interval: ",
    config.get("newMessageInterval")
  );
  newMessageCronJon = setInterval(
    generateNewMsgIntents,
    config.get("newMessageInterval")
  );
  generateNewMsgIntents()
    .then()
...
module.exports.modifyInterval = function modifyInterval() {
  console.log(
    "Modifying new message cron job interval to: ",
    config.get("newMessageInterval")
  );
